 ...
 * 
 */
package com.diilo.streetartphone.server.web.sn.controllers;
 ...
 */
@Controller
public class TwitterLoginWebController {

	private static final String	REQUESTOKEN_TWITTER_SESSION	= "requestTokenTwitter";

	private static final Logger	LOG							= LoggerFactory.getLogger(TwitterLoginWebController.class);
